...
const OrderCard: React.FC<OrderCardProps> = ({ order }) => {
  const { containerRef, showLeftArrow, showRightArrow, scroll } =
  ...
  return (
    <div className="order-card">
      <span className="order-card_status inter12-400">{order.status}</span>
      ...
      >
        ...
        <div className="order-card_items-list" ref={containerRef}>
          {order.cart &&
      ...
      <div className="order-card_sum">
        ...
        <span className="order-card_sum-value inter20-600">
          {formatPrice(totalAmount)} ₽
        </span>
      </div>
      <button className="order-card_cancel inter14-600">
        <svg
          width="12"
          height="12"
          viewBox="0 0 12 12"
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M0.219259 0.219705C0.512152 -0.0731876 0.987026 -0.0731878 1.27992 0.219705L5.99223 4.93202L10.7045 0.219705C10.9974 -0.0731876 11.4723 -0.0731879 11.7652 0.219705C12.0581 0.512598 12.0581 0.987473 11.7652 1.28037L7.05289 5.99268L11.7652 10.705C12.0581 10.9979 12.0581 11.4728 11.7652 11.7656C11.4723 12.0585 10.9974 12.0585 10.7045 11.7656L5.99223 7.05334L1.27992 11.7656C0.987026 12.0585 0.512152 12.0585 0.219259 11.7656C-0.0736338 11.4728 -0.0736338 10.9979 0.219259 10.705L4.93157 5.99268L0.219259 1.28037C-0.0736338 0.987472 -0.0736338 0.512599 0.219259 0.219705Z"
            fill="#ED2222"
          />
        </svg>
        Отменить заказ
