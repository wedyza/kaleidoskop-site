        ...
        {mobileView === 'categories' && (
          <div className="catalog-mobile_categories catalog-mobile">
            <div className="catalog-mobile_header">
              ...
              <button className="catalog-mobile_close catalog-mobile_btn" onClick={onClose}>
