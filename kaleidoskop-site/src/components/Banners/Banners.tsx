...
import './Banners.scss';
import { fetchFirstGroupBanners, fetchSecondGroupBanners } from '../../features/banners/bannersSlice';
  ...
  return (
    <div className="banners">
      <div className='banners_img-container'>
        <img className='banners_img' src={currentBanner.source} alt={currentBanner.title} />
      </div>
      <div className='banners_btns'>
        <button onClick={handlePrev} className='banners_btn'>
        ...
        <button onClick={handleNext} className='banners_btn'>
          <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
