...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen /*true*/} onClose={onClose} className="login-modal">
      {step === 'email' && (
        <>
          <h2 className="inter24-600">Вход или регистрация</h2>
      ...
      {step === 'otp' && (
        <>
          <div className="login-modal_header">
            <div className="login-modal_back">
            ...
            <h2 className="inter24-600">Введите код</h2>
          </div>
          ...
          {timer > 0 ? (
            <div className="login-modal_repeat">
              ...
              <p className="login-modal_repeat-text inter14-400">Мы отправили код на ваш email. Получить новый можно через 00:{timer}</p>
            </div>
          ) : (
            <button 
