...
const AdminCategoryForm: React.FC<AdminCategoryFormProps> = ({ type, mode }) => {
  ...
  const selectedParent = parentCategories.find(cat => cat.id === formData.parent);
        ...
        <form className="category-form">
          ...
          {type === 'category' && (
            <div className="category-form_group">
              ...
              {!formData.imageFile && formData.existingImageName && mode === 'edit' ? (
                <div className="category-form_file-selected">
                  ...
                  <span className="category-form_file-name inter13-400">
                    {formData.existingImageName.split('?')[0].split('categories/')[1]}
                  </span>
                  <div className="category-form_file-actions">
                    ...
                    >
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.220236 0.219705C0.513129 -0.0731876 0.988003 -0.0731878 1.2809 0.219705L5.99321 4.93202L10.7055 0.219705C10.9984 -0.0731876 11.4733 -0.0731879 11.7662 0.219705C12.0591 0.512598 12.0591 0.987473 11.7662 1.28037L7.05387 5.99268L11.7662 10.705C12.0591 10.9979 12.0591 11.4728 11.7662 11.7656C11.4733 12.0585 10.9984 12.0585 10.7055 11.7656L5.99321 7.05334L1.2809 11.7656C0.988003 12.0585 0.513129 12.0585 0.220236 11.7656C-0.0726573 11.4728 -0.0726572 10.9979 0.220236 10.705L4.93255 5.99268L0.220236 1.28037C-0.0726572 0.987472 -0.0726573 0.512599 0.220236 0.219705Z" fill="#B0B0B0"/>
                      </svg>
                    </button>
                  </div>
                </div>
                ...
                <div className="category-form_file-upload inter14-600">
                  ...
                  <div className='category-form_file-upload-icon'>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M4.375 16.6666C4.375 16.3214 4.65482 16.0416 5 16.0416L15 16.0416C15.3452 16.0416 15.625 16.3214 15.625 16.6666C15.625 17.0118 15.3452 17.2916 15 17.2916L5 17.2916C4.65482 17.2916 4.375 17.0118 4.375 16.6666Z" fill="#454545"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M9.55871 2.89143C9.80279 2.64735 10.1985 2.64735 10.4426 2.89143L13.3593 5.8081C13.6033 6.05218 13.6033 6.4479 13.3593 6.69198C13.1152 6.93606 12.7195 6.93606 12.4754 6.69198L10.6257 4.84226V13.3334C10.6257 13.6786 10.3458 13.9584 10.0007 13.9584C9.65547 13.9584 9.37565 13.6786 9.37565 13.3334V4.84226L7.52593 6.69198C7.28185 6.93606 6.88612 6.93606 6.64204 6.69198C6.39796 6.4479 6.39796 6.05218 6.64204 5.8081L9.55871 2.89143Z" fill="#454545"/>
                    </svg>
                  </div>
                  <label htmlFor="image-upload" className="category-form_file-btn">
                    Загрузить
                  </label>
                </div>
              ) : (
