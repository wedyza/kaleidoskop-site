...
const ListView: React.FC<ListViewProps> = ({ 
  ...
  const applyFilters = useCallback((filtersToApply: {
    ...
    const hasChanged = 
      ...
      JSON.stringify(filtersToApply.brands) !== JSON.stringify(prevFilters.brands);
