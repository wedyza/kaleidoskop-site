...
const MakeOrderPage = () => {
  ...
  const [selectedPayment, setSelectedPayment] = useState<
    "В магазине" | "Картой онлайн" | "Через СБП"
  >("В магазине");
    ...
    try {
      await dispatch(
        createOrder({
          ...
          shop:
            activeTab === "pickup" && selectedStore
              ? selectedStore.id
              : undefined,
        }),
      ).unwrap();
  ...
  const renderEditableField = (
    ...
    return (
      <div className="makeorder-item">
        <Helmet>
          <title>Калейдоскоп — Оформление заказа</title>
        </Helmet>
  ...
  const handlePaymentSelect = (
    payment: "В магазине" | "Картой онлайн" | "Через СБП",
  ) => {
  ...
  return (
    <div className="page-makeorder">
      <h1 className="makeorder-title inter28-600">Оформление заказа</h1>
      <div className="makeorder-content">
        <div className="makeorder-main">
            ...
            <div className="makeorder_del-type">
              ...
              >
                <div className="makeover_del-icon">
                  ...
                  >
                    <path
                      d="M10 0C4.5 0 0 4.31461 0 9.58802C0 16.0599 8.75 23.3708 9.125 23.7303C9.625 24.0899 10.25 24.0899 10.75 23.7303C11.25 23.3708 20 16.0599 20 9.58802C20 4.31461 15.5 0 10 0ZM10 14.382C7.25 14.382 5 12.2247 5 9.58802C5 6.95131 7.25 4.79401 10 4.79401C12.75 4.79401 15 6.95131 15 9.58802C15 12.2247 12.75 14.382 10 14.382Z"
                      fill="#727271"
                    />
                  </svg>
                </div>
                ...
                <div className="makeover_del-icon">
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M8 15.75C7.30964 15.75 6.75 16.3096 6.75 17C6.75 17.6904 7.30964 18.25 8 18.25C8.69036 18.25 9.25 17.6904 9.25 17C9.25 16.3096 8.69036 15.75 8 15.75ZM5.25 17C5.25 15.4812 6.48122 14.25 8 14.25C9.51878 14.25 10.75 15.4812 10.75 17C10.75 18.5188 9.51878 19.75 8 19.75C6.48122 19.75 5.25 18.5188 5.25 17Z"
                      fill="#727271"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M18 15.75C17.3096 15.75 16.75 16.3096 16.75 17C16.75 17.6904 17.3096 18.25 18 18.25C18.6904 18.25 19.25 17.6904 19.25 17C19.25 16.3096 18.6904 15.75 18 15.75ZM15.25 17C15.25 15.4812 16.4812 14.25 18 14.25C19.5188 14.25 20.75 15.4812 20.75 17C20.75 18.5188 19.5188 19.75 18 19.75C16.4812 19.75 15.25 18.5188 15.25 17Z"
                      fill="#727271"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M0.25 6C0.25 5.58579 0.585786 5.25 1 5.25H14.4C15.1456 5.25 15.75 5.85442 15.75 6.6V17.75H10.05C9.63579 17.75 9.3 17.4142 9.3 17C9.3 16.5858 9.63579 16.25 10.05 16.25H14.25V6.75H1C0.585786 6.75 0.25 6.41421 0.25 6Z"
                      fill="#727271"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M3 10.75C3.41421 10.75 3.75 11.0858 3.75 11.5V16.25H5.65C6.06421 16.25 6.4 16.5858 6.4 17C6.4 17.4142 6.06421 17.75 5.65 17.75H3.6C2.85442 17.75 2.25 17.1456 2.25 16.4V11.5C2.25 11.0858 2.58579 10.75 3 10.75Z"
                      fill="#727271"
                    />
                    <path
                      fill-rule="evenodd"
              ...
              <div className="makeover_del-courier">
                {deliveryAddress ? (
                  <div className="delivery-address-selected">
                    <span className="selected-address-value inter14-400">
                      {deliveryAddress}
                    </span>
                    <button
                ...
                {selectedStore ? (
                  <div className="pickup-store-selected">
                    <div className="selected-store-info">
                      <span className="store-name inter16-700">
                        {selectedStore.title}
                      </span>
                      <span className="store-address inter14-400">
                        {selectedStore.city}, {selectedStore.street},{" "}
                        {selectedStore.house}
                      </span>
                    </div>
                    <button
          ...
          <div className="makeorder_payment makeorder-section">
            <h2 className="makeorder_section-title inter18-600">Оплата</h2>
                  ...
                  {selectedPayment === "В магазине" ? (
                    ...
                    >
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2ZM12 20.1818C7.5 20.1818 3.81818 16.5 3.81818 12C3.81818 7.5 7.5 3.81818 12 3.81818C16.5 3.81818 20.1818 7.5 20.1818 12C20.1818 16.5 16.5 20.1818 12 20.1818Z"
                        fill="#EA5B21"
                      />
