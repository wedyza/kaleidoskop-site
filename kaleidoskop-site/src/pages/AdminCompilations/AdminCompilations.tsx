...
const AdminCompilations = () => {
  ...
  const { compilations } = useAppSelector((state) => state.adminCompilations);
  ...
  return (
    <div className="admin-comp">
      <div className="admin-head">
        ...
        <Link
          to="/admin/compilations/create"
          className="inter12-600 admin-cat_add-subcat admin-cat_add-item admin-comp_add-btn"
        >
        ...
        <div className="admin-nom_table inter13-400">
          ...
          <div className="admin-nom_table-content">
            {filteredCompilations.map((comp, index) => (
              <div
                className="admin-nom_row admin-nom_row-content admin-comp_row"
                key={comp.id}
              >
                ...
                <div className="admin-nom_cell">
                  {comp.start_time
                    ? formatToDDMMYYYY(comp.start_time)
                    : "- без срока"}
                </div>
                <div className="admin-nom_cell">
                  {comp.end_time
                    ? formatToDDMMYYYY(comp.end_time)
                    : "- без срока"}
                </div>
                ...
                <div className="admin-nom_cell">
                  <Link
                    to={`/admin/compilations/${comp.id}/edit`}
                    className="admin-cat_table-cell inter12-600 admin-cat_table-act admin-comp_table-act"
                  >
                    ...
                    <div className="admin-cat_table-act_img">
                      ...
                      >
                        <path
                          d="M7.6757 1.85104L8.19095 1.33579C8.972 0.554738 10.2383 0.554738 11.0194 1.33579C11.8004 2.11683 11.8004 3.38316 11.0194 4.16421L10.5041 4.67947M7.6757 1.85104L1.43661 8.09013C1.10453 8.42221 0.899906 8.86055 0.85858 9.32835L0.753531 10.5175C0.698759 11.1375 1.21763 11.6564 1.83765 11.6016L3.02681 11.4966C3.49462 11.4553 3.93296 11.2506 4.26504 10.9186L10.5041 4.67947M7.6757 1.85104L10.5041 4.67947"
                          stroke="#4F4F4F"
                          stroke-width="1.5"
                          stroke-linecap="round"
                          stroke-linejoin="round"
