    ...
    <div className='admin-tg'>
      ...
      <div className='admin-tg_info'>
        ...
        <p className='admin-tg_desc inter14-400'>
          Следуйте инструкции для подключения Telegram-бота, 
      ...
      <div className='admin-tg_content'>
        <div className='admin-tg_card admin-tg_first-step'>
          ...
          <p className='admin-tg_card-desc inter14-400'>
            Перейдите по QR-коду или найдите в поиске 
            по чтобы подключить бота
          </p>
          <div className='admin-tg_card-address'>
            ...
            >
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.75 9.41667H2.08333C1.72971 9.41667 1.39057 9.27619 1.14052 9.02614C0.890476 8.77609 0.75 8.43695 0.75 8.08333V2.08333C0.75 1.72971 0.890476 1.39057 1.14052 1.14052C1.39057 0.890476 1.72971 0.75 2.08333 0.75H8.08333C8.43695 0.75 8.77609 0.890476 9.02614 1.14052C9.27619 1.39057 9.41667 1.72971 9.41667 2.08333V2.75M6.75 5.41667H12.75C13.4864 5.41667 14.0833 6.01362 14.0833 6.75V12.75C14.0833 13.4864 13.4864 14.0833 12.75 14.0833H6.75C6.01362 14.0833 5.41667 13.4864 5.41667 12.75V6.75C5.41667 6.01362 6.01362 5.41667 6.75 5.41667Z" stroke="#B0B0B0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </button>
          </div>
          {/* {copySuccess && (
        ...
        <div className='admin-tg_card admin-tg_second-step'>
          ...
          <p className='admin-tg_card-desc inter14-400'>
            Отправьте 
            команду <span className='inter14-600 admin-tg_card__strong'>/start </span>
            и затем следуйте инструкциям 
            в Telegram-боте, чтобы получить код сессии
          </p>
          ...
          {error && (
            <div className='admin-tg_error'>
              {error}
            </div>
          )}

          {success && (
            <div className='admin-tg_success'>
