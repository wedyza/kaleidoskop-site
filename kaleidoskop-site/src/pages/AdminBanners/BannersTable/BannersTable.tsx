...
import {
  deleteAdminBanner,
  fetchAdminFirstGroupBanners,
  fetchAdminSecondGroupBanners,
  toggleBannerStatus,
  uploadAdminFirstGroupBanner,
  uploadAdminSecondGroupBanner,
  type Banner,
} from "../../../features/admin/adminBannersSlice";
...
const BannersTable = ({ group }: BannersTableProps) => {
  ...
  const banners = useAppSelector((state) =>
    group === "first"
      ? state.adminBanners.firstGroup.items
      : state.adminBanners.secondGroup.items,
  );
    ...
    <div className="admin-banners_block">
      <div className="admin-banners_block-head">
        <h2 className="inter14-600">
          ...
          {group === "first"
            ? " Первая карусель на главной странице"
            : " Вторая карусель на главной странице"}
        </h2>
        <button
        ...
        >
          ...
          >
            <path
              d="M5.41667 0.75V10.0833M0.75 5.41667H10.0833"
              stroke="#3D3D3C"
              stroke-width="1.5"
        ...
        <div className="admin-banners_table-content">
          {banners.length > 0 ? (
            banners.map((banner) => (
              <div className="admin-banners_table-row" key={banner.id}>
                ...
                <div className="admin-banners_table-cell">
                  {formatToDDMMYYYYHHMM(banner.created_at)}
                </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M6.46959 8.20705C6.59884 8.15166 6.74544 8.15325 6.87345 8.21144L14.2068 11.5448C14.4582 11.659 14.5693 11.9555 14.4551 12.2069C14.3408 12.4582 14.0444 12.5694 13.793 12.4551L6.66061 9.21315L2.19684 11.1262C1.94303 11.235 1.64909 11.1174 1.54031 10.8636C1.43153 10.6098 1.54911 10.3158 1.80292 10.207L6.46959 8.20705Z"
                        fill="#161616"
                      />
                      <path
                        fill-rule="evenodd"
                    ...
                    <span className="admin-banners_table-img__label">
                      Посмотреть баннер
                    </span>
                  </button>
                </div>
                ...
                <div className="admin-banners_table-cell admin-banners_actions">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M12.2483 3.20972L11.8216 9.86696C11.7125 11.5679 11.658 12.4183 11.2159 13.0297C10.9973 13.332 10.7158 13.5871 10.3895 13.7789C9.72931 14.1667 8.84567 14.1667 7.07841 14.1667C5.30881 14.1667 4.42401 14.1667 3.76341 13.7782C3.43681 13.5861 3.15529 13.3305 2.93677 13.0277C2.49478 12.4153 2.44146 11.5636 2.33483 9.86036L1.91846 3.20972"
                        stroke="#3D3D3C"
                        stroke-width="1.25"
                        stroke-linecap="round"
                      />
                      <path
                        d="M0.885498 3.2097H13.2814M9.87645 3.2097L9.40632 2.27453C9.09403 1.65332 8.93788 1.34272 8.66853 1.149C8.60878 1.10603 8.54552 1.06781 8.47936 1.03471C8.1811 0.885498 7.82313 0.885498 7.10721 0.885498C6.37331 0.885498 6.00636 0.885498 5.70314 1.04097C5.63594 1.07542 5.57181 1.11519 5.51143 1.15987C5.23895 1.36143 5.08675 1.6834 4.78235 2.32734L4.36524 3.2097"
                        stroke="#3D3D3C"
                        stroke-width="1.25"
                        stroke-linecap="round"
                      />
                      <path
                        d="M5.36182 10.5143L5.36182 6.52999"
                        stroke="#3D3D3C"
                        stroke-width="1.25"
                        stroke-linecap="round"
                      />
                      <path
                        d="M8.80518 10.5144L8.80518 6.53003"
                        stroke="#3D3D3C"
                        stroke-width="1.25"
                        stroke-linecap="round"
                      />
                  ...
                  <button className="admin-banners_action" aria-label="Скачать">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                  ...
                  >
                    ...
                    >
                      <path
                        d="M2.75744 5.58585L0.63623 7.70706M0.63623 7.70706L2.75744 9.82827M0.63623 7.70706H14.7776M5.58573 2.75756L7.70694 0.636353M7.70694 0.636353L9.82815 2.75756M7.70694 0.636353V14.7778M9.82815 12.6566L7.70694 14.7778M7.70694 14.7778L5.58573 12.6566M12.6564 5.58585L14.7776 7.70706M14.7776 7.70706L12.6564 9.82827"
                        stroke="#3D3D3C"
            ...
            <div className="admin-banners_empty">
              <span className="inter14-600">Пока нет баннеров</span>
