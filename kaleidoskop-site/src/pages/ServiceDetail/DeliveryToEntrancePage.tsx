...
const DeliveryToEntrancePage = () => {
  const processCards: ServiceProcessCard[] = [
    {
      id: 1,
      description:
        "При оформлении заказа на сайте выберите доставку до подъезда и укажите данные для доставки. Дождитесь звонка оператора для подтверждения.",
  ...
  return (
    <div className="service-page">
      <Helmet>
        <title>Калейдоскоп — Доставка до подъезда</title>
      </Helmet>
