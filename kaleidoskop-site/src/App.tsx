      ...
      <Routes>
        {isAdmin ? (
          <Route element={<AdminLayout />}>
            <Route element={<ProtectedRoute allowedFor="admin" />}>
              ...
              <Route
                ...
                element={<AdminNomenclatures />}
              />
              <Route
                path="/admin/nomenclatures/:id"
                element={<AdminNomenclature />}
              />
              <Route
                path="/admin/nomenclatures/connections"
                element={<AdminAssignedNomenclatures />}
              />
              <Route path="/admin/telegram" element={<AdminTelegram />} />
              <Route path="/admin/banners" element={<AdminBanners />} />
              <Route
                path="/admin/compilations"
                element={<AdminCompilations />}
              />
              <Route
                path="/admin/compilations/create"
                element={<AdminCompilationsCreate />}
              />
              <Route
                path="/admin/compilations/:id/edit"
                element={<AdminCompilationsCreate />}
              />
              ...
              <Route
                ...
                element={<AdminSubcategoryCreate />}
              />
              <Route
          ...
          <Route element={<AppLayout />}>
            ...
            <Route element={<SectionLayout />}>
              <Route
                path="/services/delivery-to-entrance"
                element={<DeliveryToEntrancePage />}
              />
              <Route
                path="/services/paint-coloring"
                element={<PaintColoringPage />}
              />
              <Route
                path="/services/water-delivery"
                element={<WaterDeliveryPage />}
              />
              <Route
                path="/services/manipulator-delivery"
                element={<ManipulatorDeliveryPage />}
              />
              <Route
                path="/services/sheet-bending"
                element={<SheetBendingPage />}
              />
              <Route
              ...
              />
              <Route
                path="/services/lift-to-apartment"
                element={<LiftToApartmentPage />}
              />
              <Route
                path="/services/transport-services"
                element={<TransportServicesPage />}
              />
            ...
            <Route
              path="/category/:categorySlug/product/:slug"
              element={<ProductPage />}
            />
